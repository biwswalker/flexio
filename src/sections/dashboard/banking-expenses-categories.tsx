    ...
    <Card sx={sx} {...other}>
      ...
      >
        <Box sx={{ py: 2, borderRight: `dashed 1px ${theme.vars.palette.divider}` }}>
          <Box sx={{ mb: 1, typography: 'body2', color: 'text.secondary' }}>หมวดหมู่</Box>
          {fNumber(9)}
        </Box>

        <Box sx={{ py: 2 }}>
          <Box sx={{ mb: 1, typography: 'body2', color: 'text.secondary' }}>รายจ่ายทั้งหมด</Box>
          {fShortenNumber(18350)}
        </Box>
      </Box>
    </Card>
  );
